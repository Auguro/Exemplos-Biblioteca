...
public class PlayerControl extends StateComponent {
    ...
    private AnimationChannel animRun, animIdle, animJump, animJumpFall, animAttack1, animAttack2, animAttack3, animDeath, animCast, animRaio;
    ...
    PlayerControl() {
        ...
        //animDeath = new AnimationChannel("/Player/hurt.png", 5, 30, 40, Duration.seconds(0.3), 0, 4);
        animDeath = new AnimationChannel("/Player/hurt.png", 4, 25, 27, Duration.seconds(0.3), 0, 4);
        animCast = new AnimationChannel("/Player/Cast.png", 6, 29, 25, Duration.seconds(0.5), 0, 5);
