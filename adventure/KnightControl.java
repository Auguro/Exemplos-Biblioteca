...
public class KnightControl extends Component {
    ...
    private final AnimationChannel animWalk, animAttack, animHurt, animBlock;
    boolean dead = false;
    ...
    public KnightControl() {
        ...
        animBlock = new AnimationChannel("/Enemy/Knight/knightblock.png", 7, 19, 36, Duration.seconds(0.3), 0, 6);
    ...
    public void onUpdate(double tpf) {
        ...
        if (physics.getVelocityX() == 0 && texture.getAnimationChannel() == animWalk) {
            ...
            if (texture.getAnimationChannel() == animIdle && texture.getAnimationChannel() != animBlock) {
                texture.loopAnimationChannel(animWalk);
            }
        }
        /*if (BlockTime.elapsed(Duration.seconds(5))) {
            EndBlock();
        }*/
    }
