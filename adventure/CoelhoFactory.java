...
public class CoelhoFactory implements EntityFactory {
    ...
    public Entity newHitbox(SpawnData data) {
        ...
        return Entities.builder()
                ...
                .from(data)
                //.viewFromNodeWithBBox(new Rectangle(4, 20, Color.BLUE))
    ...
    public Entity newHitboxLB(SpawnData data) {
        ...
        return Entities.builder()
                ...
                .from(data)
                //.viewFromNodeWithBBox(new Rectangle(5, 20, Color.RED))
    ...
    public Entity newBlock(SpawnData data) {
        ...
        physics.setBodyType(BodyType.STATIC);
        return Entities.builder()
                .type(CoelhoType.BLOCK)
                .from(data)
                //.viewFromNodeWithBBox(new Rectangle(17, 36, Color.CHARTREUSE))
                .bbox(new HitBox(BoundingShape.box(10, 36)))
                .with(new CollidableComponent(true))
                .with(physics, new ExpireCleanComponent(Duration.seconds(5)))
                .build();
    }
    ...
    public Entity newBolaDeFogo(SpawnData data) {
        ...
        return Entities.builder()
                ...
                .from(data)
                .viewFromNodeWithBBox(new Rectangle(17, 17, Color.CHARTREUSE))
                //.bbox(new HitBox(BoundingShape.box(10, 36)))
                .with(new CollidableComponent(true))
                .with(physics, new ExpireCleanComponent(Duration.seconds(4)))
